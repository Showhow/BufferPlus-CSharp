...
namespace BufferPlus.PredefinedHandler {

    class BooleanTypeHandler : BufferTypeHandler<bool> {
        public override bool Decode(byte[] buffer, bool isLittleEndian, int offset, int length) => Convert.ToBoolean(buffer[offset]);

        public override byte[] Encode(bool value, bool isLittleEndian) => new byte[] { Convert.ToByte(value) };
    ...
    class Int8TypeHandler : BufferTypeHandler<sbyte> {
        public override sbyte Decode(byte[] buffer, bool isLittleEndian, int offset, int length)=> (sbyte)buffer[offset];

        public override byte[] Encode(sbyte value, bool isLittleEndian)=> new byte[] { (byte) value };
    ...
    class UInt8TypeHandler : BufferTypeHandler<byte> {
        public override byte Decode(byte[] buffer, bool isLittleEndian, int offset, int length) {
            return buffer[0];
        }

        public override byte[] Encode(byte value, bool isLittleEndian) {
    ...
    class Int16TypeHandler : BufferTypeHandler<short> {
        #region int16 / short
        public override short Decode(byte[] buffer, bool isLittleEndian, int offset, int length) {
        ...
        public override byte[] Encode(short value, bool isLittleEndian) {
    ...
    class UInt16TypeHandler : BufferTypeHandler<ushort> {
        ...
        public override ushort Decode(byte[] buffer, bool isLittleEndian, int offset, int length) {
            var bytes = buffer.Skip(offset).Take(2).ToArray();
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
        ...
        public override byte[] Encode(ushort value, bool isLittleEndian) {
            var bytes = BitConverter.GetBytes(value);
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
    ...
    class Int32TypeHandler : BufferTypeHandler<int> {
        #region int32
        public override int Decode(byte[] buffer, bool isLittleEndian, int offset, int length) {
        ...
        public override byte[] Encode(int value, bool isLittleEndian) {
            var bytes = BitConverter.GetBytes(value);
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
    ...
    class Int64TypeHandler : BufferTypeHandler<long> {
        #region int64 / long
        public override long Decode(byte[] buffer, bool isLittleEndian, int offset, int length) {
        ...
        public override byte[] Encode(long value, bool isLittleEndian) {
            var bytes = BitConverter.GetBytes(value);
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
    ...
    class UInt64TypeHandler : BufferTypeHandler<ulong> {
        #region uint64 / ulong
        public override ulong Decode(byte[] buffer, bool isLittleEndian, int offset, int length) {
            var bytes = buffer.Skip(offset).Take(8).ToArray();
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
        ...
        public override byte[] Encode(ulong value, bool isLittleEndian) {
            var bytes = BitConverter.GetBytes(value);
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
    ...
    class FloatTypeHandler : BufferTypeHandler<float> {
        ...
        public override float Decode(byte[] buffer, bool isLittleEndian, int offset, int length) {
            var bytes = buffer.Skip(offset).Take(4).ToArray();
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
        ...
        public override byte[] Encode(float value, bool isLittleEndian) {
            var bytes = BitConverter.GetBytes(value);
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
    ...
    class DoubleTypeHandler : BufferTypeHandler<double> {
        ...
        public override double Decode(byte[] buffer, bool isLittleEndian, int offset, int length) {
            var bytes = buffer.Skip(offset).Take(8).ToArray();
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
        ...
        public override byte[] Encode(double value, bool isLittleEndian) {
            var bytes = BitConverter.GetBytes(value);
            if (isLittleEndian) {
                Array.Reverse(bytes, 0, bytes.Length);
            }
