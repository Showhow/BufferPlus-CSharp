...
namespace BufferPlus {
    ...
    class Example {
        ...
        static void Main(string[] args) {
            ...
            //read
            bp_4.Position = 0;
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<bool>\t" + JsonConvert.SerializeObject(bp_4.Read<bool>()));
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<sbyte>\t" + JsonConvert.SerializeObject(bp_4.Read<sbyte>()));
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<byte>\t" + JsonConvert.SerializeObject(bp_4.Read<byte>()));
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<short>\t" + JsonConvert.SerializeObject(bp_4.Read<short>()));
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<ushort>\t" + JsonConvert.SerializeObject(bp_4.Read<ushort>()));
            ...
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<long>\t" + JsonConvert.SerializeObject(bp_4.Read<long>()));
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<ulong>\t" + JsonConvert.SerializeObject(bp_4.Read<ulong>()));
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<float>\t" + JsonConvert.SerializeObject(bp_4.Read<float>()));
            Console.WriteLine("Buffer 4: \t " + bp_4.Position + "\t Read<double>\t" + JsonConvert.SerializeObject(bp_4.Read<double>()));
